...
/**
 * Provides the local service interface for Statess. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see StatessLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface StatessLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.training.zain.states.service.impl.StatessLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the statess local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link StatessLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Statess addStatess(Statess statess);
	...
	public Statess createStatess(int id);
	...
	public Statess deleteStatess(int id) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Statess deleteStatess(Statess statess);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Statess fetchStatess(int id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Statess getStatess(int id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Statess> getStatesses(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Statess updateStatess(Statess statess);
