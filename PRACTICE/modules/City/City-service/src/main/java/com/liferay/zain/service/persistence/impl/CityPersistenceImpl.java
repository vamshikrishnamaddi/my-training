...
package com.liferay.zain.service.persistence.impl;
...
import com.liferay.zain.model.impl.CityImpl;
import com.liferay.zain.model.impl.CityModelImpl;
import com.liferay.zain.service.persistence.CityPersistence;
import com.liferay.zain.service.persistence.CityUtil;
import com.liferay.zain.service.persistence.impl.constants.ZainPersistenceConstants;
...
public class CityPersistenceImpl
	...
	protected void cacheUniqueFindersCache(CityModelImpl cityModelImpl) {
		...
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, cityModelImpl, false);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if ((cityModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
				cityModelImpl.getOriginalUuid(),
				cityModelImpl.getOriginalGroupId()
			};
	...
	public City updateImpl(City city) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {
				cityModelImpl.getUuid(), cityModelImpl.getCompanyId()
			};
			...
			if ((cityModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					cityModelImpl.getOriginalUuid(),
					cityModelImpl.getOriginalCompanyId()
				};
	...
	public void activate() {
		...
		_finderPathFetchByUUID_G = new FinderPath(
			...
			CityModelImpl.UUID_COLUMN_BITMASK |
			CityModelImpl.GROUPID_COLUMN_BITMASK);
		...
		_finderPathWithoutPaginationFindByUuid_C = new FinderPath(
			...
			new String[] {String.class.getName(), Long.class.getName()},
			CityModelImpl.UUID_COLUMN_BITMASK |
			CityModelImpl.COMPANYID_COLUMN_BITMASK);
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.liferay.zain.model.City"),
			true);
	}
