...
/**
 * Provides the local service interface for normal. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see normalLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface normalLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.zain.practice.service.impl.normalLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the normal local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link normalLocalServiceUtil} if injection and service tracking are not available.
	 */
